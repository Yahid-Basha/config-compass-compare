        ...
        <div className="container mx-auto px-4 py-8 relative z-10">
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="flex gap-3">
              <Button variant="outline" onClick={resetComparison} className="backdrop-blur-sm bg-white/70 border-2 border-white hover:bg-white/80 rounded-2xl">
                <FileText className="h-4 w-4 mr-2" />
                New Comparison
              </Button>
              <Button onClick={handleDownloadReport} className="bg-[#EE001E] hover:bg-[#EE001E]/90 border-2 border-white rounded-2xl shadow-lg">
                <Download className="h-4 w-4 mr-2" />
                Download Report
              </Button>
              <Button onClick={handleSimulateAlert} variant="outline" className="border-2 border-white text-[#FF281E] hover:bg-[#FF281E]/10 backdrop-blur-sm bg-white/70 rounded-2xl">
          ...
          <Card className="shadow-2xl border-0 backdrop-blur-md bg-white/80 rounded-3xl overflow-hidden">
            ...
            <CardContent className="p-8">
              <Tabs value={inputMethod} onValueChange={(value) => setInputMethod(value as 'upload' | 'paste')} className="mb-8">
                <div className="relative p-1 backdrop-blur-sm bg-white/70 border-2 border-gray-300 rounded-2xl">
                  {/* Sliding background indicator */}
                  <div 
                    className={`absolute top-1 bottom-1 w-1/2 bg-black rounded-xl transition-transform duration-300 ease-in-out ${
                      inputMethod === 'upload' ? 'translate-x-0' : 'translate-x-full'
                    }`}
                  />
                  
                  <TabsList className="grid w-full grid-cols-2 bg-transparent relative z-10">
                    <TabsTrigger 
                      value="upload" 
                      className={`flex items-center gap-2 rounded-xl transition-colors duration-300 ${
                        inputMethod === 'upload' 
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <Textarea
                        ...
                        className="min-h-[300px] font-mono text-sm backdrop-blur-sm bg-white/70 border-2 border-white rounded-2xl"
                      />
                    </div>
                    <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full p-2 border-2 border-white rounded-2xl focus:ring-2 focus:ring-[#EE001E] focus:border-transparent backdrop-blur-sm bg-white/70"
                    >
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      className="backdrop-blur-sm bg-white/70 border-2 border-white rounded-2xl"
                    />
                    <p className="text-xs text-gray-500 mt-1">
              ...
              <div className="flex justify-center mt-8">
                <Button
                  ...
                  size="lg"
                  className="bg-gradient-to-r from-[#EE001E] to-[#FF281E] hover:from-[#EE001E]/90 hover:to-[#FF281E]/90 text-white px-8 py-3 text-lg disabled:opacity-50 disabled:cursor-not-allowed border-2 border-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
                >
                  {isComparing ? (
                    <>
