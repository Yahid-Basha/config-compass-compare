...
const FileUploader: React.FC<FileUploaderProps> = ({ onFilesChange }) => {
  ...
  const FileDropZone = ({ type, file }: { type: 'source' | 'target'; file: File | null }) => (
    <Card className={`relative transition-all duration-200 backdrop-blur-md border-gray-300 shadow-lg rounded-3xl ${
      dragOver === type 
        ? 'border-[#EE001E] border-2 bg-[#EE001E]/5 shadow-xl' 
        : 'border-dashed border-2 border-gray-400 hover:border-gray-500 bg-white/80'
    }`}>
          ...
          {file ? (
            <div className="space-y-4">
              <div className="flex items-center justify-center">
                <div className="p-3 bg-green-100/80 rounded-full backdrop-blur-sm shadow-lg">
              ...
              <Button
                ...
                className="text-red-600 border-red-300 hover:bg-red-50 backdrop-blur-sm bg-white/80 border-2 shadow-lg hover:shadow-xl rounded-2xl transition-all duration-200"
              >
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-center">
                <div className={`p-4 rounded-full ${
                  dragOver === type ? 'bg-[#EE001E]/10' : 'bg-gray-100/80'
              ...
              <div>
                ...
                <label
                  ...
                  className="cursor-pointer inline-flex items-center px-4 py-2 backdrop-blur-sm bg-white/80 border-2 border-gray-300 rounded-2xl shadow-lg text-sm font-medium text-gray-700 hover:bg-white/90 hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#EE001E] focus:border-transparent transition-all duration-200"
                >
