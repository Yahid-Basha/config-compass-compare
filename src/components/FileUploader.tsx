          ...
          {file ? (
            <div className="space-y-4">
              ...
              <Button
                ...
                className="text-red-600 border-red-300 hover:bg-red-50 backdrop-blur-sm bg-white/70 border-2 border-white rounded-2xl"
              >
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <label
                  ...
                  className="cursor-pointer inline-flex items-center px-4 py-2 backdrop-blur-sm bg-white/70 border-2 border-white rounded-2xl shadow-sm text-sm font-medium text-gray-700 hover:bg-white/80 focus:outline-none focus:ring-2 focus:ring-[#EE001E] focus:border-transparent transition-all duration-200"
                >
